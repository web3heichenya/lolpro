...
import { HeroBasicsPanel } from './components/HeroBasicsPanel'
import { BuildAugmentsCard } from './components/BuildAugmentsCard'
import { BuildItemsCard } from './components/BuildItemsCard'
import { BuildSkillsCard } from './components/BuildSkillsCard'
import { BuildSynergiesCard } from './components/BuildSynergiesCard'
...
export function AramMayhemDetailView({
  champions,
  selectedChampion,
  championProfile,
  build,
