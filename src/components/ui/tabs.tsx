...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-full border border-border/60 bg-muted/30 p-1 text-muted-foreground backdrop-blur',
      className,
    )}
    {...props}
  />
